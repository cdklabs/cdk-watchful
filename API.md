...
* **props** (<code>[WatchfulProps](#cdk-watchful-watchfulprops)</code>)  *No description*
  ...
  * **dashboardName** (<code>string</code>)  The name of the CloudWatch dashboard generated by Watchful. Overrides dashboard property if specified.
  * **dashboard** (<code>boolean</code>)  Whether to generate a dashboard.
 __*Default*__: true
